...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Fazenda Scott — Gerenciador da Fazenda" },
      {
        name: "description",
        content:
          "Gerencie produtos, estoque, vendas, encomendas e gastos da Fazenda Scott. Da terra para você.",
      },
      { name: "author", content: "Fazenda Scott" },
